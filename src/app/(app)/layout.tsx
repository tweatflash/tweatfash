...
const HomeLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const Authentication=async ()=>{
    ...
    if (request === undefined ){
      ...
      setError({
        ...
        "description":"Upgrade now to keep going, or continue coding for free in the editor."
      })
    }else if (request.status && request.status===200){
      setUserObj(request.data)
      setIsLoading(false)
      setPrevent(false)
  ...
  if (isLoading || prevent) return <ThemeProvider attribute="class"><Loader loading={isLoading} error={error}/></ThemeProvider>;
      ...
      <nav className="fixed mobile:hidden bottom-0 w-full h-16 border-t border-[hsl(var(--border-color))] border-solid z-20 bg-[hsl(var(--background)/.9)] backdrop-blur-md flex flex-1 gap-2 px-2">
        <span className="w-full py-2 flex-1 flex justify-center">
          <Link href={"/home"} className="h-full flex flex-col justify-center">
            <div className={`flex items-center justify-center rounded-full ${mainpathname ==="home" && "bg-[hsl(var(--accent))] border border-[hsl(var(--border-color))]"} w-16 h-8`}>
              {
                ...
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="stroke-black fill-black dark:stroke-white dark:fill-white size-5 aspect-square"
                >
                  <g>
                    <path d="M21.591 7.146L12.52 1.157c-.316-.21-.724-.21-1.04 0l-9.071 5.99c-.26.173-.409.456-.409.757v13.183c0 .502.418.913.929.913H9.14c.51 0 .929-.41.929-.913v-7.075h3.909v7.075c0 .502.417.913.928.913h6.165c.511 0 .929-.41.929-.913V7.904c0-.301-.158-.584-.408-.758z"></path>
                  </g>
                ...
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="dark:fill-white size-5 aspect-square"
                >
                  <g>
                    <path d="M21.591 7.146L12.52 1.157c-.316-.21-.724-.21-1.04 0l-9.071 5.99c-.26.173-.409.456-.409.757v13.183c0 .502.418.913.929.913h6.638c.511 0 .929-.41.929-.913v-7.075h3.008v7.075c0 .502.418.913.929.913h6.639c.51 0 .928-.41.928-.913V7.904c0-.301-.158-.584-.408-.758zM20 20l-4.5.01.011-7.097c0-.502-.418-.913-.928-.913H9.44c-.511 0-.929.41-.929.913L8.5 20H4V8.773l8.011-5.342L20 8.764z" />
                  </g>
            ...
            <span className="text-current text-xs m-auto">Home</span>
          </Link>
        </span>
        <span className="w-full py-2 flex-1">
          <Link href={"/communites"} className="h-full flex flex-col justify-center">
            <div className={`flex items-center justify-center rounded-full ${mainpathname ==="communites" && "bg-[hsl(var(--accent))] border border-[hsl(var(--border-color))]"} m-auto w-16 h-8`}>
              {
                mainpathname==='communites' ?
                  <svg
                    viewBox="0 0 24 24"
            ...
            <span className="text-current text-xs m-auto">Communites</span>
          </Link>
        </span>
        <span className="w-full py-2 flex-1">
          <div onClick={()=>setOpenSearch(true)} className="h-full cursor-pointer flex w-full flex-col justify-center">
            <div className="flex items-center justify-center rounded-full hover:bg-[hsl(var(--accent))] w-16 h-8 m-auto">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="fill-black dark:fill-white size-5 aspect-square"
              >
                <g>
                  <path d="M10.25 3.75c-3.59 0-6.5 2.91-6.5 6.5s2.91 6.5 6.5 6.5c1.795 0 3.419-.726 4.596-1.904 1.178-1.177 1.904-2.801 1.904-4.596 0-3.59-2.91-6.5-6.5-6.5zm-8.5 6.5c0-4.694 3.806-8.5 8.5-8.5s8.5 3.806 8.5 8.5c0 1.986-.682 3.815-1.824 5.262l4.781 4.781-1.414 1.414-4.781-4.781c-1.447 1.142-3.276 1.824-5.262 1.824-4.694 0-8.5-3.806-8.5-8.5z"></path>
                </g>
            ...
            <span className="text-current text-xs m-auto">Explore</span>
          </div>
        </span>
        

        <span className="w-full py-2 flex-1">
          <Link href={"bookmarks"} className="h-full flex flex-col justify-center">
            <div className={`flex items-center m-auto justify-center rounded-full ${mainpathname ==="bookmarks" && "bg-[hsl(var(--accent))] border border-[hsl(var(--border-color))]"} w-16 h-8`}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="dark:fill-white size-5 aspect-square"
            ...
            <span className="text-current text-xs m-auto">Bookmarks</span>
          </Link>
        </span>
