export default function Section3() {
  return (
    <div className="flex flex-col gap-12 relative w-full">
            ...
            <div className="relative w-full grid lg:grid-cols-3 gap-5 !justify-center !flex-1 md:grid-cols-2 ">
              <div className="flex gap-5 lg:order-none order-1 flex-col ">
                <div className="p-[30px] flex  flex-col rounded-[20px] border border-[hsl(var(--border-color))] gap-[30px] bg-[rgb(9,9,10)] ">
                    <div className="p-[14px] w-fit border border-[hsl(var(--border-color))] rounded-[14px] bg-[rgb(24,24,26)] ">
              ...
              <div className="relative justify-self-center isolate order-0 col-span-full lg:order-2 lg:col-span-1 md:justify-self-center w-full md:min-w-[700px] lg:min-w-0 h-[390px]  md:h-[496px] lg:h-full  border-0 overflow-hidden flex justify-center">
                
                <div className="absolute h-[418px] md:h-[498px] bottom-0 w-full">
                  <img className="w-full h-full" src="https://framerusercontent.com/images/G5E3Hg44KVQi3oAJd4bMzA4lC4k.svg"/>
                </div>
                <div className="contents">
                  <div className="absolute h-[476px] w-[241px] lg:w-[309px] md:h-[611px] md:w-[309px]  top-0">
                    <div className="w-full h-full overflow-hidden">
                      <div className="absolute inset-0 bottom-0">
                        <img src="https://framerusercontent.com/images/I9yRU9jEN2S2ol2M7kgT5c6zOrc.png" alt="Mobile Image" className="w-full  h-full block object-cover object-center"/>
                      </div>
                      <div className="inset-x-[10px] inset-y-[14px] absolute bg-black rounded-[32px] overflow-hidden">
                        <div className="inset-0">
                          <img src="https://framerusercontent.com/images/wd8bRGMtBOSwdqQ3jrEi9zbd58.png" alt="" className="w-full rounded-[32px] h-full block object-cover object-center"/>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex self-start justify-self-start gap-5 order-2 lg:order-3 flex-col">
                <div className="p-[30px] flex flex-col rounded-[20px] border border-[hsl(var(--border-color))] gap-[30px] bg-[rgb(9,9,10)] ">
                    <div className="p-[14px] w-fit border border-[hsl(var(--border-color))] rounded-[14px] bg-[rgb(24,24,26)] ">
                      <div className="w-[30px] h-[30px]">
