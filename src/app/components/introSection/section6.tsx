                ...
                <div className="w-full flex items-center flex-col gap-[14px] relative">
                    ...
                    <div className="flex flex-col gap-5 max-w-[1200px] w-full">
                        <div className="flex items-center justify-center w-full">
                            <h2 className="font-bold text-[38px] md:text-[58px] text-white text-center leading-[1.2]">Discover Tweatflash Features</h2>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full">
                {feautres.map((item,index)=>(
                    <div className="w-full relative " key={index}>
                        <div className="w-full h-min rounded-[20px] border border-[hsl(var(--border-color))] flex flex-col">
                        <div className="max-h-[294px] h-auto aspect-[1.316326530612245/1] w-full relative flex justify-center flex-col overflow-hidden">
                            ...
                            <div className="absolute h-[175px] w-full bottom-0">
                                <div className="absolute bottom-0">
                                    <img className="w-full h-full" src="https://framerusercontent.com/images/vSXeDeiftCFIZjNVBWtvTj0ibk.svg" alt=""/>
                                </div>
                            </div>
                        </div>
